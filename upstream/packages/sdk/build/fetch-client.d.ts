 ...
 */
export declare function getMediaPlaylist({ id, key, sessionId, slug, variantIndex, xImmichHlsPos }: {
    id: string;
    key?: string;
    sessionId: string;
    slug?: string;
 ...
 */
export declare function searchAssets({ key, slug, metadataSearchDto }: {
    key?: string;
    slug?: string;
...
export declare enum HlsVideoResolution {
    $480 = 480,
    $720 = 720,
    $1080 = 1080,
    $1440 = 1440,
