 ...
 */
export function getMediaPlaylist({ id, key, sessionId, slug, variantIndex, xImmichHlsPos }, opts) {
 ...
 */
export function searchAssets({ key, slug, metadataSearchDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/search/metadata${QS.query(QS.explode({
        key,
        slug
    }))}`, oazapfts.json({
        ...opts,
...
export var HlsVideoResolution;
(function (HlsVideoResolution) {
    HlsVideoResolution[HlsVideoResolution["$480"] = 480] = "$480";
    HlsVideoResolution[HlsVideoResolution["$720"] = 720] = "$720";
    HlsVideoResolution[HlsVideoResolution["$1080"] = 1080] = "$1080";
    HlsVideoResolution[HlsVideoResolution["$1440"] = 1440] = "$1440";
    HlsVideoResolution[HlsVideoResolution["$2160"] = 2160] = "$2160";
})(HlsVideoResolution || (HlsVideoResolution = {}));
