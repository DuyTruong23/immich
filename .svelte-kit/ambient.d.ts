...
declare module '$env/static/private' {
	export const IMMICH_BUILD: string;
	export const IMMICH_SERVER_URL: string;
	export const VITE_IMMICH_API_URL: string;
	...
	export const EFC_13668_1592913036: string;
	export const EFC_13668_4126798990: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_ENABLE_EXPLORE: string;
	...
	export const PUBLIC_SESSION_ONLY_AUTH: string;
	export const PUBLIC_THEME: string;
	export const PUBLIC_IMMICH_WS_URL: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DriverData: string;
		EDITOR: string;
		EFC_13668_1592913036: string;
		EFC_13668_4126798990: string;
		EXEPATH: string;
		FORCE_COLOR: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_DEFAULT_THEME: string;
		PUBLIC_ENABLE_ADMIN: string;
		PUBLIC_ENABLE_ANALYTICS: string;
		PUBLIC_ENABLE_ARCHIVE: string;
		PUBLIC_ENABLE_DASHBOARD: string;
		PUBLIC_ENABLE_EXPERIMENTAL: string;
		PUBLIC_ENABLE_EXPLORE: string;
		PUBLIC_ENABLE_FOLDERS: string;
		PUBLIC_ENABLE_MAP: string;
		PUBLIC_ENABLE_MEMORIES: string;
		PUBLIC_ENABLE_PARTNER: string;
		PUBLIC_ENABLE_PEOPLE: string;
		PUBLIC_ENABLE_SEARCH: string;
		PUBLIC_ENABLE_SHARED_LINKS: string;
		PUBLIC_ENABLE_SHARING: string;
		PUBLIC_ENABLE_TAGS: string;
		PUBLIC_ENABLE_TRASH: string;
		PUBLIC_ENABLE_UTILITIES: string;
		PUBLIC_ENABLE_WORKFLOWS: string;
		PUBLIC_IMMICH_BUY_HOST: string;
		PUBLIC_IMMICH_PAY_HOST: string;
		PUBLIC_IMMICH_SERVER_URL: string;
		PUBLIC_SESSION_ONLY_AUTH: string;
		PUBLIC_THEME: string;
		PUBLIC_IMMICH_WS_URL: string;
